...
Version 1.9 · Web tool · Built from `MBA_Comp_Calculator.xlsx`
This document is both the **student user manual** and the **operational guide** for whoever maintains this tool going forward.

---

**▶ Live tool:** **[Comp Negotiation Tool](https://coryjburk.github.io/toolkit-comp_lifecycle/mba_comp_negotiation_tool.html)**

---

**v1.9 changes:** updated the live-tool link to the renamed repo (`toolkit-comp_negotiation` → `toolkit-comp_lifecycle`, part of the toolkit-wide rebrand to "Comp Lifecycle Toolkit"), pointed it directly at this tool's page instead of the hub root, and reverted "Comp Negotiation Toolkit" back to "Comp Negotiation Tool" in the title/heading — this document is about the one tool, not the three-tool toolkit as a whole.
...
- Version tag in the top-right of the masthead should be bumped on any functional change, following the same versioning convention as the PE/PM/TMAY tools.
